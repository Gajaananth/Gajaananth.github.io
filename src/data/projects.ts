...
export const projects: Project[] = [
  {
    ...
    tagline: "Full-stack system for loans, savings, customers, and branch-level financial workflows.",
    description:
  ...
  },
  {
    ...
    tagline: "Disaster-resilient SOS platform built for fail-safe communication and emergency response.",
    description:
    ...
    features: [
      ...
      "Fail-safe and layered communication design",
      "Offline and resiliency-focused architecture",
    ],
    architecture: [
      "Mobile: Flutter",
      "Backend: Django",
      "Communication model: layered fail-safe design",
  ...
  },
  {
    ...
    description:
      "A full-stack digital presence for a technology-driven brand, designed to clearly communicate service offerings and product value.",
    problem:
    ...
    solution:
      "A responsive website with a structured service narrative, polished presentation layer, and full-stack deployment setup suited for product storytelling.",
    features: [
    ...
    architecture: [
      "Frontend: React + Vite",
      "Backend/API layer: full-stack service architecture",
    ...
    technologies: ["React", "TypeScript", "Vercel", "Full-stack", "UI Design"],
    status: "Production",
